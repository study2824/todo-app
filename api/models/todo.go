...
var TodoWhere = struct {
	...
	Text:      whereHelperstring{field: "\"todo\".\"text\""},
...
var (
	todoAllColumns            = []string{"id", "title", "text", "created_at"}
	todoColumnsWithoutDefault = []string{"title", "text"}
	todoColumnsWithDefault    = []string{"id", "created_at"}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert todo")
	}
